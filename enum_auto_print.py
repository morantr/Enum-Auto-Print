...
class Configuration():
    def __init__(self):
        ...
        self.code_snippet_open_message: str = "// Enum AutoPrint generated code snippet begining- DON'T EDIT!\n"
...
class EnumAutoPrint:
    ...
    def upgrade_enum(self, file_path: str):
        ...
        f = open(file_path, "r", self.conf.encoding)
        lines = f.readlines()
        f.close()
...
def read_configuration(conf: Configuration) -> Tuple[str, str]:
    ...
    if (redirect_stdout_to_log_file_key in configuration.keys()):
        if configuration[redirect_stdout_to_log_file_key]:
            Configuration.redirect_stdout_to_file()
...
if __name__ == '__main__':
    ...
    EnumAutoPrint.conf = conf
    for file_path in files_list:
        EnumAutoPrint.upgrade_enum(file_path)
